...
class StatusViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UINavigationControllerDelegate {
    ...
    var foodTargetColor = #colorLiteral(red: 0.07843137255, green: 0.5568627451, blue: 1, alpha: 0.5)
    var foodCurrentColor = #colorLiteral(red: 0, green: 0.4784313725, blue: 1, alpha: 1)
    var grillTargetColor = #colorLiteral(red: 1, green: 0.3098039216, blue: 0.2666666667, alpha: 0.5)
    var grillCurrentColor = #colorLiteral(red: 1, green: 0.3098039216, blue: 0.2666666667, alpha: 1)
    var timer: Timer?
    ...
    // MARK: iOS-CHARTS CUSTOMIZATION AND METHODS
    ...
    func customizeGraphAppearance() {
        ...
        leftAxis.labelTextColor = grillCurrentColor
        leftAxis.axisLineColor = grillCurrentColor
        ...
        rightAxis.axisMaximum = 175
        rightAxis.axisMinimum = 50
        rightAxis.labelTextColor = foodCurrentColor
        rightAxis.axisLineColor = foodCurrentColor
    ...
    func drawGraph() {
        ...
        let grillTargetLine = LineChartDataSet(values: grillTargetLineData, label: "TargetGrill")
        ...
        let foodTargetLine = LineChartDataSet(values: foodTargetLineData, label: "TargetFood")
        ...
        let grillCurrentLine = LineChartDataSet(values: grillCurrentLineData, label: "Grill")
        ...
        let foodCurrentLine = LineChartDataSet(values: foodCurrentLineData, label: "Food")
...
extension UILabel {
    func animateForControlState(control: UISwitch) {
        ...
        if control.isOn {
            self.text = "RUNNING"
            highlightColor = #colorLiteral(red: 0, green: 0.9768045545, blue: 0, alpha: 1)
        } else {
            self.text = "STOPPING"
            highlightColor = #colorLiteral(red: 1, green: 0.1491314173, blue: 0, alpha: 1)
        }
